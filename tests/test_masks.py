...
@pytest.mark.parametrize(
    "invalid_card", ("159683786870519", "1596837868705194555", "159")
)
...
@pytest.mark.parametrize(
    "invalid_account", ("6468647367889477958956665", "646864736788949589", "646864736")
)
...
def test_get_mask_account_isdigit():
    assert (
        get_mask_card_number("6468647e67889t779589") == "Вы ввели некоректные данные!"
    )
