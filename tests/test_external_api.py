...
def test_get_amount_rub_not_rub():
    ...
    mock_get.assert_called_once_with(f'https://api.apilayer.com/exchangerates_data/convert?from=USD&to=RUB&amount=8221.37', headers={'apikey': API_KEY})
