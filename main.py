...
if __name__ == '__main__':
    card_nums = [
        "Maestro 1596837868705199", "MasterCard 7158300734726758", "Счет 35383033474447895560",
...
if __name__ == '__main__':
    ...
    currency_list = filter_by_currency(transactions, 'USD')
    print(next(currency_list))
...
if __name__ == '__main__':
    transactions = [{"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572",
            ...
            "description": "Перевод организации", "from": "Visa Platinum 1246377376343588",
            "to": "Счет 14211924144426031657"}]
    transaction_list = transaction_descriptions(transactions)
    print(next(transaction_list))
    gener_card = card_number_generator(1, 9999999999999999)
    print(next(gener_card))
